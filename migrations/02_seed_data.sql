INSERT INTO users (password, role, iin, login, first_name, last_name, email) VALUES
('admin123', 'ADMIN', '123456789012', 'admin', 'Admin', 'User', 'admin@example.com'),
...
('stud123', 'STUDENT', '123456789014', 'student', 'Alice', 'Johnson', 'student@example.com');
...
INSERT INTO students (year_study, is_expelled, school, user_id) VALUES
(1, FALSE, 'CS', (SELECT id FROM users WHERE login = 'student'));
...
('CS101', 2, 'L', 'Mon', '12:00:00', '14:00:00', '424', 200),
...
(1, 'CS101', 1, 85.00, 'B', 3.33, 5.0, 'Completed');
...
('Welcome to the Semester', 'The semester starts on September 1st!', TRUE, 1),
